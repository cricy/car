(function (window, document) {
    ...
    function Orientation() {
        ...
        if (typeof CustomEvent === "function") {
            this.event = new CustomEvent('orientation', {
                bubbles: true,
                cancelable: true
            });
        } else if (typeof document.createEvent === "function") {
            this.event = document.createEvent('Event');
            this.event.initEvent('orientation', true, true);
        } else {
          return false;
        }
    }
    ...
    Orientation.prototype.devicemotion = function (e) {
    ...
    var myShakeEvent = new Orientation();
